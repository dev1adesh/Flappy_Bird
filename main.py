import random #Random num generation
...
def welcomeScreen():
    ...
    while True:
        for event in pygame.event.get():
            #if user clicks on cross, end game
            if event.type == QUIT or (event.type == KEYDOWN and event.key == K_ESCAPE):
                pygame.quit()
                sys.exit()

            #If user presses space of up key, start game
...
if __name__ == "__main__":
    #This will be the main function/point from where our game will start
    pygame.init() #INitialize all pygame modules
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption('Flappy Bird by Adesh')
    ...
    GAME_SOUNDS['die'] = pygame.mixer.Sound('Gallery/Audio/dead.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('Gallery/Audio/flap.wav')
